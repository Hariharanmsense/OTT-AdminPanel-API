...
class HotelRepository extends BaseRepository implements HotelService
{
    ...
    public function Viewhotellist($inputData){
        ...
        //print_R($inputData->decoded->userName);die();
        ...
        try{
            ...
            $brandid = isset($inputData->decoded->brandId)?$inputData->decoded->brandId:"";
    ...
    public function getsinglehotel($groupid, $userid,$userName){
        ...
        try{
            ...
            $grpData = $getonehotelmodel->gethoteloneModel($groupid, $userid,$userName);
    ...
    public function delete($hotelid, $userid,$userName){
        ...
        try{
            ...
            $getonehotelmodel = new HotelModel($this->loggerFactory, $this->dBConFactory);
            $grpData = $getonehotelmodel->delete($hotelid, $userid,$userName);
            $objLogger->info("======= End Hotel Repository ================");
            return $grpData;
        }
        catch (HotelException $ex) {
