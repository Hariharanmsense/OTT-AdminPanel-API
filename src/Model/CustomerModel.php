...
class CustomerModel extends BaseModel
{
    ...
    public function ViewhotelList($userid,$username,$brandid){
        $objLogger = $this->loggerFactory->addFileHandler($username.'_Hotelmodel.log')->createInstance('Hotelmodel');
        try 
        {
    ...
    public function gethoteloneModel($hotelid,$userid,$userName){
        ...
        $objLogger = $this->loggerFactory->addFileHandler('_Hotelmodel_'.$userName.'.log')->createInstance('Hotelmodel');
        try 
        {
            $action = "GETONE";
