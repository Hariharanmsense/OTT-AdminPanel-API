...
final class ChannelAction extends Action
{
    ...
    public function getchannelsList(Request $request, Response $response, array $args): Response
    {
      ...
      try {  
          ...
          $hotellist = $this->channelrepository->ViewChannellist($JWTdata);
    ...
    public function create(Request $request, Response $response, array $args): Response
    {
      ...
      try {  
		  ...
		  */
          ...
          $insStatus = $this->channelrepository->create($JWTdata,$channelimg);
    ...
    public function getOnechanneldetail(Request $request, Response $response, array $args): Response
    {
      ...
      try {  
          ...
          $inputType = gettype($args['id']);
          $objLogger->info("Input Type : ".$inputType);
          // if(strtolower($inputType) == 'string'){
          //   throw new ChannelException('Invalid Parameter', 500);
          // }       
      ...
      try {  
		 ...
		 // print_r($fileinfo);die();
			...
			/*if(($staticwidth < $width) || ($staticheight < $height ) || (($staticwidth < $width)&&($staticheight < $height))){
				throw new ChannelException('Channel logo size must 600*290.', 301);
			}*/
			
		  
          $channelid = isset($args['id'])?$args['id']:'0';
          $insStatus = $this->channelrepository->update($JWTdata, $channelid, $userid,$channelimg);
